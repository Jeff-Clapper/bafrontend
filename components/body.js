    ...
    return (
        <div id={ styles.base } className={styles.baseColor}>
            <div className={ styles.bodyContainer }>
                ...
                <BodyComp style="contact" width={ width } bodyTitle="Ready to Start?" currentPageSetter = { props.currentPageSetter } bodyText="We would love an opportunity to get to know more about you and your company. Select the 'Contact Us' button below, fill out the form, and we will set up a time to meet with you and your team!" />
            </div>
        </div>
